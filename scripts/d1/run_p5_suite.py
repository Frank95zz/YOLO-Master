    ...
    def execute(self):
        ...
        write_json(
            launch,
            {
                ...
                "ema_implementation": self.matrix.get("ema_implementation", "scalar-v1"),
                "resume_temperature_policy": self.matrix.get("resume_temperature_policy", "legacy"),
                "resume_rank_buffers": self.matrix.get("resume_rank_buffers", False),
                "seed": 0,
                "screen_epochs": 50,
                "schedule_epochs": 100,
                "global_batch": 384,
