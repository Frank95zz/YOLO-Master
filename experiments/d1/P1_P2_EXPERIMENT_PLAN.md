...
2026-09-10 用户已授权：采用 BN64，检查通过后启动第一阶段；随后将种子数改为 3。第一批完成后先报告官方三 seed 结果与第二批 ETA，第二批 9 次待确认，不自动扩展至 E4。
...
| E3 VisDrone aux（2026-09-10 修订） | 27 + 9 = 36 次，各 60 轮，共 2,160 epochs | 两阶段全部候选三 seed；待 BN64 完整 epoch 基准，ETA 含加载、定期/最终评测，不照搬 COCO 每轮时间 |
