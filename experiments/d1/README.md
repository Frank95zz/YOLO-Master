...
**结果更新（北京时间 2026-09-13）：** 12/12 组固定末轮训练与官方评分已完成，COCO/VisDrone 三 seed 精度、显存、训练 GPU-hours、配对区间和产物校验已更新。VisDrone 周期快照的官方评分作为标准 best 补充继续归档。
...
**主结果完成状态：** 12/12 组固定末轮训练与官方评分、COCO 和 VisDrone 三 seed 汇总已完成。补充的 VisDrone 周期快照官方 MATLAB 评分继续归档，用于独立列示标准 best；它不改变已经完成的固定末轮主表。
