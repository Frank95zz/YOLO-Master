...
| COCO / 50 / seed 0 | Scratch | 末轮独立评测进行中 | 40.828 / 43.541 | 5.4838 | 32.9026 |

2026-09-12 COCO Scratch seed 0 已完成全部50轮：完整train2017 118,287张、val2017 5,000张，640输入、六卡A40、全局batch384，BF16训练/FP32评测；六rank各15,450次有效更新，训练及验证损失均有限。训练作业19,741.533秒，固定末轮checkpoint SHA256为 1e3d96fc4ef5909d5e16717e154873332248cb9c9dc1759f1c0c5e9ccc48a8f3。周期快照正依次独立评测，主结果使用第50轮，不以较早周期的最高AP替代；对照组完成后再计算COCO的精度保留率与成本降低率。
