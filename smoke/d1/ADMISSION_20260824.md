...
1. 从 COCO test2017 官方 image-info 固定排序后选取前 100 张不同图片，并记录官方 URL 和源文件 SHA256。
...
脚本只接受干净工作树，自动从 COCO 官方 S3 准备 100 图 mini split、锁定当前 commit、执行两次缓存、比较哈希，并重跑测试、训练和预测。
